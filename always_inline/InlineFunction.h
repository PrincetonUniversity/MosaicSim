...
static cl::opt<bool>
EnableNoAliasConversion("local-enable-noalias-to-md-conversion", cl::init(true),
                         cl::Hidden,
                         cl::desc("Convert noalias attributes to metadata during inlining."));
 
static cl::opt<bool>
PreserveAlignmentAssumptions("local-preserve-alignment-assumptions-during-inlining",
                             cl::init(true), cl::Hidden,
                             cl::desc("Convert align attributes to assumptions during inlining."));

std::string LocalInlineFunction(CallSite CS, InlineFunctionInfo &IFI,
                           AAResults *CalleeAAR,
                           bool InsertLifetime,
...
std::string LocalInlineFunction(CallSite CS, InlineFunctionInfo &IFI,
   ...
   { // Scope to destroy VMap after cloning.
     ...
     errs() << "The Pass: Caller: " << Caller->getName() << " Caleee: " << CalledFunc->getName() << "\n";

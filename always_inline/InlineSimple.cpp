...
#define DEBUG_TYPE "myinlinesimple"
...
public:
  SimpleInliner() : LegacyInlinerBase(ID), Params(llvm::getInlineParams()) {
    errs() << "YOU GOTTA PRINT SOMETHING!!!\n" ;
...
static RegisterPass<SimpleInliner> X("myinlinesimple", "Inline Simple Pass");

INITIALIZE_PASS_BEGIN(SimpleInliner, "myinlinesimple", "Function Integration/Inlining",
                      false, false)
...
INITIALIZE_PASS_END(SimpleInliner, "myinlinesimple", "Function Integration/Inlining",
                    false, false)
